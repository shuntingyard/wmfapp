...
# SOURCE https://github.com/twitterdev/enterprise-scripts-python/blob/main/Engagement-API/generate_user_access_tokens.py
...
# Request an OAuth Request Token. This is the first step of the 3-legged
# OAuth flow. This generates a token that you can use to request
